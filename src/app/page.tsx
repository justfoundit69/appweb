    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16 flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <p className="text-xl text-[#222222] mb-8 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tools.map((tool) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[#000000] mb-2 group-hover:text-[#000000] transition-colors">
                  {tool.name}
                </h3>
                <p className="text-[#222222] group-hover:text-[#000000] transition-colors">
                  {tool.description}
                </p>
                <div className="mt-4 flex items-center text-[#000000] font-medium group-hover:text-[#000000] group-hover:translate-x-1 transition-all">
                  Use Tool
