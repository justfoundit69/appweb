    ...
    <div className="min-h-screen py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="card p-6">
          <div className="rounded-md border border-[#000000]/25 bg-white/10 p-6 text-[#000000]">
            ...
            <p className="text-sm">
              Please use the share link from <Link href="/token-locker/my-lock" className="text-[#000000] hover:underline font-semibold">My Locks</Link> page which includes both addresses.
            </p>
          </div>
        </div>
      </div>
