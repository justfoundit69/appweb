    ...
    <RequireWallet>
      <div className="min-h-screen py-8 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-[#000000] mb-2">Multi-Send</h1>
              ...
              <div className="card p-8">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-[#000000]">Token Selection</h3>
                  ...
                  <option value="native">Native Token (ETH)</option>
                      ...
                      {watch('tokenType') === 'prc20' && (
                        <div>
                          ...
                          />
                          {needsApproval && (
                            <div className="mt-4 p-4 bg-white/70 border border-[#000000]/30 rounded-lg">
                  ...
                  {/* File Upload Section */}
                  <div className="space-y-4">
                      <h3 className="text-lg font-semibold text-[#000000]">Upload Recipients</h3>
                    <FileDrop
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold text-[#000000]">Manual Entry</h3>
                      <button
                        type="button"
            ...
            <div className={`lg:col-span-4 ${isComingSoon ? 'blur-sm select-none pointer-events-none user-select-none' : ''}`}>
              <div className="card p-6 lg:sticky lg:top-24 space-y-4">
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-[#000000]/20 rounded-lg p-4">
                  <h4 className="font-medium text-[#000000] mb-2">Multi-Send Fee</h4>
                  <p className="text-sm text-[#222222]">
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-[#000000]/20 rounded-lg p-4">
                  <p className="text-sm text-[#222222]">Token Type</p>
                  <p className="text-lg font-bold text-[#000000]">
                    {watch('tokenType') === 'native' ? 'Native (ETH)' : 'Token'}
                  </p>
                  <p className="text-sm text-[#222222] mt-4">Recipients</p>
                  <p className="text-2xl font-bold text-[#000000]">{recipients.length}</p>
                  <p className="text-sm text-[#222222] mt-4">Estimated Total</p>
                  <p className="text-2xl font-bold text-[#000000]">{totalAmount.toLocaleString()} tokens</p>
                  {watch('tokenType') === 'native' && (
                    <>
                      <p className="text-sm text-[#222222] mt-4">Total ETH Required</p>
                      <p className="text-lg font-bold text-[#000000]">
                ...
                <div className={`border rounded-lg p-4 ${
                  process.env.NEXT_PUBLIC_MULTISEND 
                    ...
                    : 'bg-white/70 backdrop-blur-sm border border-[#000000]/20'
                }`}>
                  <p className={`text-sm ${
                    process.env.NEXT_PUBLIC_MULTISEND 
                      ? 'text-[#000000]'
